...
public abstract class TaskDao {
    ...
    public void deleteAndPopulate() {
        ...
        Task[] tasks = new Task[] {
                new Task(1, "Task name #1", "Task description #1", now + one_day, false, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Personal"),
                new Task(2, "Task name #2", "Task description #2", now + one_day*2, false, Task.PRIORITY_HIGH, now, Task.NOT_SET, false, "Shopping"),
                new Task(3, "Task name #3", "Task description #3", now + one_day*3, false, Task.PRIORITY_LOW, now, Task.NOT_SET, false, "Work"),
                new Task(4, "Task name #4", "Task description #4", -1, true, Task.PRIORITY_MEDIUM, now, Task.NOT_SET, false, "Sport"),
                new Task(5, "Task name #5", "Task description #5", -1, true, Task.PRIORITY_NONE, now, Task.NOT_SET, true, "Movies to watch"),
                new Task(6, "Task name #6", "Task description #6", now + one_day, false, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Personal"),
                new Task(7, "Task name #7", "Task description #7", now + one_day*4, false, Task.PRIORITY_LOW, now, Task.NOT_SET, false, "Shopping"),
                new Task(8, "Task name #8", "Task description #8", now + one_day, true, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Work"),
                new Task(9, "Task name #9", "Task description #9", -1, false, Task.PRIORITY_HIGH, now, Task.NOT_SET, false, "Sport"),
                new Task(10, "Task name #10", "Task description #10", now + one_day, false, Task.PRIORITY_NONE, now, Task.NOT_SET, true, "Movies to watch"),
                new Task(11, "Task name #11", "Task description #11", now + one_day*3, false, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Personal"),
                new Task(12, "Task name #12", "Task description #12", now + one_day*4, false, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Shopping"),
                new Task(13, "Task name #13", "Task description #13", now + one_day, true, Task.PRIORITY_MEDIUM, now, Task.NOT_SET, false, "Work"),
                new Task(14, "Task name #14", "Task description #14", now + one_day*5, false, Task.PRIORITY_NONE, now, Task.NOT_SET, true, "Sport"),
                new Task(15, "Task name #15", "Task description #15", now + one_day, true, Task.PRIORITY_NONE, now, Task.NOT_SET, false, "Movies to watch")
        };
