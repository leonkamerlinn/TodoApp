...
public class SortNone implements SortState {

    private final TaskDao taskDao;
    private final String selectedCategory;

    public SortNone(TodoRoomDatabase todoRoomDatabase, String selectedCategory) {
    ...
    public LiveData<List<Task>> getTasksLiveData() {
        ...
        return taskDao.getCategoryTasksLiveData(selectedCategory);
    }

    @Override
    public Single<List<Task>> getSingle() {
        if (selectedCategory.equals("All")) {
            return taskDao.getTasksSingle();
        }

        return taskDao.getCategoryTasksSingle(selectedCategory);
    }
}
